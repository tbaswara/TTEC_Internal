<!DOCTYPE html>
<html lang="en">
    <?php echo form_open_multipart('c_main/coba_upload');?>
  <head>
    <meta charset="utf-8">
...
<body id="page-top" class="index">
	...
	<tr>
	<th>Word :</th>
	<td><input name = "words" type = "text" placeholder="Isi Kata " value = "" ></td>
	<td style="color:blue;"><?php echo form_error('words');?></td>
	</tr>
        
        <tr>
	<th>Furigana :</th>
	<td><input name = "furigana" type = "text" placeholder="Isi Kata furigana " value = "" ></td>
	<td style="color:blue;"><?php echo form_error('furigana');?></td>
	</tr>
	
	<tr>
	<th>Romaji :</th>
	<td><input name = "romaji" type = "text" placeholder="Isi romawi" value = "" ></td>
	<td style="color:blue;"><?php echo $path;?></td>
	</tr>
        
        <tr>
        <th>Meaning :</th>
        <td><input name = "meaning" type = "text" placeholder="Isi Arti" value = "" ></td>
	<td style="color:blue;"><?php echo $error;?></td>
	</tr>
        ...
        <input type = "file" name = "userfile" size = "20" /> 
         <br />
         <input type = "submit" value = "TEUING" />  
		...
		<tr>
                    <td> <input class="btn btn-default" type="submit" name="kuda"></td>
		</tr>
   </table>
      </div>
