      ...
      <div class="container">
		...
		?>
                ...
                <tr>
                    ...
                    <td></td>
                    <td><?php  
            $total_query="SELECT SUM(Jumlah_Transaksi) AS TotalTransaksi FROM transaksi WHERE Tipe_Transaksi='Pemasukan' AND Nama_Proyek='".$proyek_key."';";
            ...
            ?></td>
               ...
               <td><?php  
            $total_query="SELECT SUM(Jumlah_Transaksi) AS TotalTransaksi FROM transaksi WHERE Tipe_Transaksi='Pengeluaran' AND Nama_Proyek='".$proyek_key."';";
            $cdresult=mysql_query($total_query) or die ("Query to get data from firsttable failed: ".mysql_error());
            while ($cdrow=mysql_fetch_array($cdresult)) {
