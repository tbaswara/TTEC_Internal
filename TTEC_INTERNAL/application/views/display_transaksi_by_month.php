    ...
    <div class="jumbotron">
      <div class="container">
		...
		?>
           ...
           $total_query="SELECT SUM(Jumlah_Transaksi) AS TotalTransaksi FROM transaksi WHERE (Tipe_Transaksi='Pemasukan' AND Month(Tanggal_Transaksi)='".$month."') AND Year(Tanggal_Transaksi)='".$year."'  ;";
            ...
            $total_query="SELECT SUM(Jumlah_Transaksi) AS TotalTransaksi FROM transaksi WHERE (Tipe_Transaksi='Pengeluaran' AND Month(Tanggal_Transaksi)='".$month."') AND Year(Tanggal_Transaksi)='".$year."' ;";
            $cdresult=mysql_query($total_query) or die ("Query to get data from firsttable failed: ".mysql_error());
            while ($cdrow=mysql_fetch_array($cdresult)) {
