    ...
    <div class="jumbotron">
      <div class="container">
		...
		<tr bgcolor="green"><th>ID Transaksi</th><th>Nama Transaksi</th><th>Tanggal Transaksi</th> <th>Pemasukan</th> <th>Pengeluaran</th>
                    <th>Keterangan</th> <th>Nama_Toko</th> <th>Nama_Proyek</th>
		...
		<td><?php echo anchor('c_main/update1_transaksi/'.$data->ID_Transaksi,'Edit');?></td>
		<td><?php echo anchor('c_main/hapus_transaksi/'.$data->ID_Transaksi,'Hapus');?></td></tr>
		...
		?>
                ...
                <tr>
                    ...
                    <td></td>
                    <td><?php  
            $total_query="SELECT SUM(Jumlah_Transaksi) AS TotalTransaksi FROM transaksi WHERE Tipe_Transaksi='Pemasukan' AND Nama_Transaksi='".$pencarian."';";
            ...
            ?></td>
               ...
               <td><?php  
            $total_query="SELECT SUM(Jumlah_Transaksi) AS TotalTransaksi FROM transaksi WHERE Tipe_Transaksi='Pengeluaran' AND Nama_Transaksi='".$pencarian."';";
            $cdresult=mysql_query($total_query) or die ("Query to get data from firsttable failed: ".mysql_error());
            while ($cdrow=mysql_fetch_array($cdresult)) {
