...
<li>
  ...
  <?php
            ...
            <button class=""> <?php echo anchor('c_main/display_lesson3', 'Lanjut ke lesson3'); ?> </button>
            </center>
                <?php } 
            ...
            <button class=""> <?php echo anchor('c_main/display_lesson2', 'Kembali ke Lesson 2'); ?> </button>
            </center>
            <?php
                }
