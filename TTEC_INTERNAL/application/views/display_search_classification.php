...
<body id="page-top" class="index">
    ...
    <section id="services">
		...
		<tr bgcolor="green"><th>No</th><th>Words</th><th>Furigana</th> <th>Romaji</th> <th>Meaning</th> <th>TTEC WORDS</th> 
		...
		<td><?php echo $data->TTEC_Words; ; ?></td>
               <td><?php if($data->Picture!=NULL)
                {?>
                    <img src="<?php echo base_url()?><?php echo $data->Picture;?>" class="img-responsive" alt="Cinque Terre"  >
                <?php }
                else echo $data->Picture;
                ?>
                </td>
