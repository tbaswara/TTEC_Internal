      ...
      <div class="container">
		...
		<?php echo form_open('c_main/search');?>
			<center>
				<tr>
                    ...
                    <input type="submit" value="Sort by Date"/></td>
                    <?php echo form_close(); ?>
		...
		?>
                ...
                <tr>
                    ...
                    <td></td>
                    <td><?php  
            $total_query="SELECT SUM(Jumlah_Transaksi) AS TotalTransaksi FROM transaksi WHERE Tipe_Transaksi='Pemasukan';";
            ...
            ?></td>
               ...
               <td><?php  
            $total_query="SELECT SUM(Jumlah_Transaksi) AS TotalTransaksi FROM transaksi WHERE Tipe_Transaksi='Pengeluaran';";
            $cdresult=mysql_query($total_query) or die ("Query to get data from firsttable failed: ".mysql_error());
            while ($cdrow=mysql_fetch_array($cdresult)) {
